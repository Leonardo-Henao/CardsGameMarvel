...
class IniciarCuentaRegresivaUseCaseTest {
    ...
    private Flux<DomainEvent> historico2() {
        ...
        var event2 = new JugadorAgregado(
                ...
                new Mazo(Set.of(
                        new Carta(CartaMaestraId.of("CARTAÑERY"), 1000, true, true, "name", "url"),
                        ...
                        new Carta(CartaMaestraId.of("ggg"), 160, true, true, "name", "url")
                )));
        ...
        var event3 = new JugadorAgregado(
                ...
                new Mazo(Set.of(
                        new Carta(CartaMaestraId.of("CARTAPERRY"), 999, true, true, "name", "url"),
                        ...
                        new Carta(CartaMaestraId.of("ggga"), 160, true, true, "name", "url")
                )));
        ...
        //JUGADOR 1//
        var event7 = new CartaPuestaEnTablero(event4.getTableroId(), event2.getJugadorId(), new Carta(CartaMaestraId.of("CARTAÑERY"), 1000, true, true, "name", "url"));
        event7.setAggregateRootId("XXXX");

        var event8 = new CartaQuitadaDelMazo(event2.getJugadorId(), new Carta(CartaMaestraId.of("CARTAÑERY"), 1000, true, true, "name", "url"));
        event8.setAggregateRootId("XXXX");

        //JUGADOR 2//
        var event9 = new CartaPuestaEnTablero(event4.getTableroId(), event3.getJugadorId(), new Carta(CartaMaestraId.of("CARTAPERRY"), 999, true, true, "name", "url"));
        event9.setAggregateRootId("XXXX");

        var event10 = new CartaQuitadaDelMazo(event3.getJugadorId(), new Carta(CartaMaestraId.of("CARTAPERRY"), 999, true, true, "name", "url"));
