...
class FinalizarRondaUseCaseTest {
        ...
        StepVerifier
                ...
                .expectNextMatches(domainEvent -> {
                    ...
                    return event.aggregateRootId().equals("JuegoId1")
                            ...
                            && event.getCartasApuesta().equals(Set.of(new Carta(CartaMaestraId.of("CartaMaestraId1"), 1000, true, true, "name", "url"),
                            new Carta(CartaMaestraId.of("CartaMaestraId2"), 999, true, true, "name", "url")));
                }).expectNextMatches(domainEvent -> {
    ...
    private Flux<DomainEvent> historico() {
        ...
        var event2 = new JugadorAgregado(
                ...
                new Mazo(Set.of(
                        new Carta(CartaMaestraId.of("CartaMaestraId1"), 1000, true, true, "name", "url"),
                        new Carta(CartaMaestraId.of("bbb"), 102, true, true, "name", "url"),
                        new Carta(CartaMaestraId.of("ccc"), 101, true, true, "name", "url"),
                        new Carta(CartaMaestraId.of("ddd"), 104, true, true, "name", "url"),
                        new Carta(CartaMaestraId.of("fff"), 150, true, true, "name", "url")
                )));
        ...
        var event3 = new JugadorAgregado(
                ...
                new Mazo(Set.of(
                        new Carta(CartaMaestraId.of("CartaMaestraId2"), 999, true, true, "name", "url"),
                        new Carta(CartaMaestraId.of("bbba"), 102, true, true, "name", "url"),
                        new Carta(CartaMaestraId.of("ccca"), 101, true, true, "name", "url"),
                        new Carta(CartaMaestraId.of("ddda"), 104, true, true, "name", "url"),
                        new Carta(CartaMaestraId.of("fffa"), 150, true, true, "name", "url")
                )));
        ...
        //JUGADOR 1//
        var event7 = new CartaPuestaEnTablero(event4.getTableroId(), event2.getJugadorId(), new Carta(CartaMaestraId.of("CartaMaestraId1"), 1000, true, true, "name", "url"));
        event7.setAggregateRootId("JuegoId1");

        var event8 = new CartaQuitadaDelMazo(event2.getJugadorId(), new Carta(CartaMaestraId.of("CartaMaestraId1"), 1000, true, true, "name", "url"));
        event8.setAggregateRootId("JuegoId1");

        //JUGADOR 2//
        var event9 = new CartaPuestaEnTablero(event4.getTableroId(), event3.getJugadorId(), new Carta(CartaMaestraId.of("CartaMaestraId2"), 999, true, true, "name", "url"));
        event9.setAggregateRootId("JuegoId1");

        var event10 = new CartaQuitadaDelMazo(event3.getJugadorId(), new Carta(CartaMaestraId.of("CartaMaestraId2"), 999, true, true, "name", "url"));
