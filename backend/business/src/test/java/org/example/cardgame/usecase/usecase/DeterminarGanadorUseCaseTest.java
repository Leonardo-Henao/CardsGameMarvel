...
class DeterminarGanadorUseCaseTest {
    ...
    private Flux<DomainEvent> historico() {
        ...
        var event2 = new JugadorAgregado(
                ...
                "Raul",
                new Mazo(Set.of(
                        new Carta(CartaMaestraId.of("111"), 5, true, true, "name", "url"),
                        new Carta(CartaMaestraId.of("222"), 6, true, true, "name", "url"),
                        new Carta(CartaMaestraId.of("333"), 7, true, true, "name", "url"),
                        new Carta(CartaMaestraId.of("444"), 8, true, true, "name", "url"),
                        new Carta(CartaMaestraId.of("555"), 9, true, true, "name", "url"),
                        new Carta(CartaMaestraId.of("666"), 11, true, true, "name", "url")
                )
                )
        );
